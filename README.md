...
- **Java 21, Spring Boot**
- **SQL, PostgreSQL**, modelagem relacional, índices e otimização de consultas, migrações
- **Testes unitários e de integração:** JUnit 5, Mockito, Rest Assured
- **Segurança:** autenticação e autorização, controle de acesso
- **Infra & DevOps:** Docker, Git, GitFlow, Grafana, Prometheus, Kubernetes
- **Cloud & Arquitetura:** AWS, microserviços
